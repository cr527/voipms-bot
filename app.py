  ...
  OPENCLAW_GATEWAY_URL = os.environ.get('OPENCLAW_GATEWAY _URL', 'https://api.openclaw.ai')                             
  OPENCLAW_GATEWAY_TOKEN = os.environ.get('OPENCLAW_GATEWAY _TOKEN', 'your_token_here')                                 
  ...
  def sms_reply():                                                                                                      
      ...
      if message_lower == "sexy":                                                                                       
          ...
          for light in hue_lights:                                                                                      
              # Wrapped in parentheses to avoid backslash line continuation errors                                      
              # Used single quotes for light['name'] to avoid breaking the f-string                                     
              command = (                                                                                               
